...
export const en = {
  ...
  welcome: {
    ...
    slide2Title: 'Offer Your Services',
    slide2Description: 'Register your profile and make yourself available for work',
    slide3Title: 'Connect Directly',
    slide3Description: 'Direct contact with workers, no middleman involved',
  ...
  profileSetup: {
    ...
    locationPlaceholder: 'Click Fetch to get current location',
    fetchLocation: 'Fetch',
    locationFetchFailed: 'Failed to fetch location. Please check your location permissions.',
  ...
  home: {
    ...
    searchLabour: 'Search by profession, location, name or keyword',
    nearbyLabours: 'Nearby Labours',
    allLabours: 'All Available Labours',
    noLabours: 'No labours available',
    filters: 'Filters',
    sortBy: 'Sort By',
    nearby: 'Nearby',
  ...
  labourDetails: {
    ...
    location: 'Location',
    navigate: '🗺️ Navigate',
    locationNotAvailable: 'Location not available for this labourer',
    mapOpenFailed: 'Failed to open maps. Please try again.',
    about: 'About',
    rating: 'Rating',
    reviews: 'Reviews',
  },
